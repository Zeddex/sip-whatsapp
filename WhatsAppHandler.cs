...
namespace SipIntercept
{
    public class WhatsAppHandler
    {
        ...
        private WaveFileWriter _waveFile = new WaveFileWriter("output.mp3", new WaveFormat(8000, 16, 1));

        public WhatsAppHandler(string user, string password, string domain, int port = 5060, int expire = 120)
        {
        ...
        private VoIPMediaSession CreateRtpSession(SIPUserAgent ua, string dst)
        {
            ...
            //rtpAudioSession.OnRtpPacketReceived += RecordIncomingCall;
            //rtpAudioSession.OnRtpPacketReceived += SendRtpPacket;
        ...
        private void RecordIncomingCall(IPEndPoint remoteEndPoint, SDPMediaTypesEnum mediaType, RTPPacket rtpPacket)
        {
        ...
        private void SendRtpPacket(IPEndPoint remoteEndPoint, SDPMediaTypesEnum mediaType, RTPPacket rtpPacket)
        {
            udpClient.Send(rtpPacket.Payload, rtpPacket.Payload.Length, remoteEndPoint);
        }
    }
}
